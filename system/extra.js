...
Socket = (...args) => {
      ...
      return client.sendMessage(jid, {
         ...
         contextInfo: {
            ...
            externalAdReply: {
               ...
               sourceUrl: 'https://chat.whatsapp.com/GLDpzSjcXpZIp007nLaRNy'
            }
         }
      }, {
         quoted
      ...
      return client.sendMessage(jid, {
         ...
         contextInfo: {
            ...
            externalAdReply: {
               ...
               thumbnail: pic,
               sourceUrl: 'https://wa.me/6285831796696?text=sewabot+bang'
            }
         }
      }, {
         quoted
      ...
      return client.sendMessage(jid, {
         ...
         contextInfo: {
            ...
            externalAdReply: {
               ...
               sourceUrl: 'https://wa.me/6285831796696?text=bang+upgrade+premium+biar+unlimited+limit'
            }
         }
      }, {
         quoted
   ...
   client.sendButton3 = async (jid, source, text, footer, quoted, buttons = [], type, opts) => {
      ...
      let options = (type && type.location) ? {
         ...
         showAdAttribution: false,
         title: opts && opts.title ? opts.title : '© 02Botz-Md',
         thumbnail: opts && opts.thumbnail ? opts.thumbnail : await Func.fetchBuffer(global.db.setting.cover),
         thumbnailUrl: 'https://telegra.ph/?id=' + Func.makeId(8),
         sourceUrl: 'https://chat.whatsapp.com/GLDpzSjcXpZIp007nLaRNy'
            }
