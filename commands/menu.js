      ...
      try {
         if (/menu|help|bot/.test(command)) {
            ...
            let buttons = [{
               urlButton: {
                        displayText: `OWNER`,
                        url: `https://wa.me/6285831796696?text=order+bot+bang`
                     }
                  },
                  {
                     quickReplyButton: {
	    ...
	    largeThumb: true,	
            thumbnail: global.db.setting.cover
               ...
               client.menu[id] = [
                  await client.sendTemplateButton(m.chat, global.db.setting.cover, await menu(m, readmore, global.db.setting, isPrefix), '                 ᴋᴀɴɴᴀ ᴠ𝟸.𝟶.𝟽 (ᴘᴜʙʟɪᴄ ʙᴏᴛ)  ', buttons, {
                     document: true,
                     name: '© 02Botz-Md'
                  }),
                  setTimeout(() => {
               ...
               client.menu[id] = [
                  await client.sendTemplateButton(m.chat, await Func.fetchBuffer('./media/images/thumb.mp4'), await menu(m, readmore, global.db.setting, isPrefix), '                         *K A N N A B O T*', buttons, {
                     gif: true
                  }),
                  setTimeout(() => {
                     delete client.menu[id]
...
Im 02Botz-Md (ᴘᴜʙʟɪᴄ ʙᴏᴛ), *gunakan bot di private chat agar bot dapat merespon dengan cepat.*
