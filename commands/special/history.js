...
exports.run = {
   ...
   async: async (m, {
      ...
      if (command == 'tfpoint') {
         ...
         await client.sendList(m.chat, '', info(), '© Nan', 'Tap!', rows, m)
      }
   },
   error: false
}
...
➠ *Penting!* simpan nomor owner dan gabung ke dalam grup official : (https://chat.whatsapp.com/GLDpzSjcXpZIp007nLaRNy)`
}